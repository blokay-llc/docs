...
Start your application to ensure Blokay loads correctly. You should see the`<web-component resource="BlokayResource"></web-component>` component functional in your app.
